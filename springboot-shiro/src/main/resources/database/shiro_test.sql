...
values (1, '\0', '用户管理', 0, '0/', 'userInfo:view', 'menu', 'userInfo/userList'),
       (2, '\0', '用户添加', 1, '0/1', 'userInfo:add', 'button', 'userInfo/userAdd'),
       (3, '\0', '用户删除', 1, '0/1', 'userInfo:del', 'button', 'userInfo/userDel');
...
values (1, '管理员', 'd3c59d25033dbf980d29554025c23a75', '8d78869f470951332959580424d4bf4f', 0, 'admin');
